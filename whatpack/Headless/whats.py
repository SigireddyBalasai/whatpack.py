...
class WhatsApp:
    """THis class will allow us to login to whatsapp web and then send messages
    ...
    def login(self):
        """This is used either to login the user or ensure that is user is already logged in"""
        driver = self.driver
        try:
            driver.get('https://web.whatsapp.com/')
            WebDriverWait(driver, 60).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="app"]/div/div/'
                                                'div[3]/div[1]/div/div/div[2]/div/canvas')))
